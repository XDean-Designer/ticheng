...
| 列表页配套 | 删「生效中」；卡面「合计」左置 + 提成 2×2（项目 / 产品 / 办卡·充卡 / 快速消费，无进度条；点格可直达业绩提成明细，**返回回员工薪资列表**）；结算周期页结算日/发薪日均可 **1–31**（当月无该日则 clamp 月末；**仅店主/合伙人可改结算周期全部项**） |
...
| 行卡片 | 分类标签：**项**蓝 `#4A90D9` / **产**红 `#F32F41` / **卡**绿 `#3CB371` / **快**=橙色闪电图标（无方底）；标题行右侧时间；业绩/提成同行；提成侧 **edit-02**（店主/合伙人/**店长**） |
