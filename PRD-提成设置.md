...
| 按工位 + 关 | 每工位只填/显示一个参数（提成卡 + 虚线条并排） | 开单选员工**不再**选点客（联调页须隐藏） |
...
**Dialog/Sheet**：方案名称、重命名方案、请输入方案名称、确认删除该方案？、删除后不可恢复。、确认删除该规则项？、尚未保存、尚未保存，确定要返回吗？、留在本页、不保存、多方案规则、计算基数说明、分配模式说明、未分配任何提成方案、暂无在岗员工、**选择员工、提成、点客、+ 点客提成、大工、中工、小工**。
