...
> **v2.1（2026-08-31）员工薪资改版**：删列表「生效中」；结算周期增发薪日（店主/合伙人；默认=结算日+12·30日制）；列表卡「合计」+ 提成 2×2；新页「员工薪资明细」（业绩支付四格含签单=经理签单+欠款、提成五类、服务=项目+快消实收、售卡=办卡+充卡实收）；取消提成待确认全流程，店主改提成直接生效+留痕；业绩只读；业绩提成明细月合计与上对齐。
