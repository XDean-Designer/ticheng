...
**入口行 / 摘要行**：同前。摘要文案：仅点客 → `点客`；选了工位 → **仅工位名**（如 `大工`，不带「散客」）；不分工位+开点客散客 → `散客`；**不分工位+未开点客** → 卡片第三行仍为**灰色头衔**（无红色提成摘要），入口摘要行不写 meta。
...
**导航/按钮**：提成设置、添加提成方案、添加规则项、保存、取消、确定、完成、下一步、全选、清空、重命名、复制方案、删除、改名、分配员工、已分配、未分配、已选 N 人、还有 N 人未分配任何提成方案、**基数、适用范围**、5 项默认、5 项默认 · N 条覆盖、项目、产品、会员卡、办卡、充卡、整类 · {组名}、修改记录、**关联页面、头衔空态 sheet、方案空态 sheet、选择服务员工**、**点客、散客、小工、中工、大工、不分工位、按工位、未选择、已选 N 人**、**设置、头衔管理、角色管理、选择头衔、创建员工、邀请员工、查看记录**。

**规则卡**：原价、实收、**固定**、提成、点客、大工、中工、小工、**基数**、**适用范围**、计算基数、分配模式、不分工位、按工位分配、按比例 %、固定金额 ¥、现金、卡付、团购、提成参数。

**Dialog/Sheet**：方案名称、重命名方案、请输入方案名称、确认删除该方案？、删除后不可恢复。、确认删除该规则项？、尚未保存、尚未保存，确定要返回吗？、留在本页、不保存、多方案规则、计算基数说明、分配模式说明、未分配任何提成方案、暂无在岗员工、**选择员工、提成、点客、+ 点客提成、大工、中工、小工**；开单侧选人（跨系统，沿用旧版文案）：**点客 / 散客**。
